...
export const createPermissions = (
  permission: components['schemas']['api__schemas__me__ProfilePermissionsResponse']
) => {
  return {
    ...
    call_permission: toString(permission.group_invite_permission),
    force_auto_delete_messages_in_private:
      permission.force_auto_delete_messages_in_private,
    max_message_auto_delete_seconds: toString(
